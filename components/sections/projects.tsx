...
const projects = [
  {
    ...
    liveUrl: "https://insider.ibratdebate.uz",
    githubUrl: "#"
  },
  {
    title: "SmartFit",
    description: "LMS with encrypted video streaming, Payme payment integration, full backend/frontend stack with FastAPI & React",
  ...
  {
    title: "11Tutors",
    description: "University course platform from students for students, built with performance in mind",
  ...
  {
    title: "KreativPark",
    description: "Library seat booking system with real-time seat availability via Django WebSockets and React",
  ...
  {
    title: "Parvoz",
    description: "Landing page with beautiful UI — built with frontend-only tech using modern UI principles",
