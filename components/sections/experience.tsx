...
const experiences = [
  {
    ...
    description: "Developed and maintained scalable backend systems using Python, Django, and FastAPI. Implemented real-time features with WebSockets and optimized database queries for improved performance.",
    skills: ["Python", "Django", "FastAPI", "PostgreSQL", "Redis", "WebSockets"]
  },
  {
    company: "Ibrat Farzandlari / Yoshlar agentligi",
    position: "Software Engineer",
    period: "2024 April - Present",
    description: "Built and maintained Telegram bots for various business needs including a QR library system. Implemented complex workflows and integrations with external APIs.",
  ...
  },
  {
    ...
    position: "Software Engineer",
    period: "2025 - Present",
    description: "Worked on various freelance projects across edtech and productivity domains. Designed and implemented full-stack solutions from concept to deployment.",
